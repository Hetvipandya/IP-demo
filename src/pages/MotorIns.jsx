            ...
            <main className="w-full lg:w-2/3 lg:sticky lg:top-6 lg:max-h-[calc(100vh-48px)] lg:overflow-y-auto no-scrollbar space-y-8 pr-2">
              ...
              <div className="flex items-center gap-5 text-xs font-semibold uppercase tracking-wider text-slate-500 bg-white/60 backdrop-blur-sm inline-flex px-4 py-2 rounded-full border border-slate-100 shadow-sm">
                <span className="flex items-center gap-1.5">
                  <FaUser className="text-red-500" /> Felixaeroprop
                </span>
                <div className="h-3 w-px bg-slate-200"></div>
                <span className="flex items-center gap-1.5">
                  <FaCalendarAlt className="text-blue-500" /> November 2, 2022
                </span>
              </div>
              ...
              <article className="bg-white p-6 sm:p-10 rounded-2xl border border-slate-100 shadow-sm space-y-6">
                ...
                <ul className="space-y-4 text-slate-600">
                  <li className="flex items-start gap-3">
                    ...
                    <span><strong className="text-slate-800">Third-Party Liability Insurance:</strong> Covers damage to another person's property or injury caused by your vehicle.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="flex-shrink-0 w-2 h-2 rounded-full bg-red-500 mt-2.5"></span>
                    <span><strong className="text-slate-800">Comprehensive Insurance:</strong> Offers complete coverage for your own vehicle's damages as well as third-party liabilities.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="flex-shrink-0 w-2 h-2 rounded-full bg-red-500 mt-2.5"></span>
                    <span><strong className="text-slate-800">Own Damage Insurance:</strong> Protects your vehicle against theft, fire, accidents, and natural disasters.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="flex-shrink-0 w-2 h-2 rounded-full bg-red-500 mt-2.5"></span>
                    <span><strong className="text-slate-800">Commercial Vehicle Insurance:</strong> Special coverage for trucks, taxis, and other vehicles used for business purposes.</span>
                  </li>
                </ul>
                ...
                <ul className="space-y-3.5 text-slate-600">
                  <li className="flex items-start gap-3">
                    ...
                    <span>Financial coverage for repairs and replacements due to accidents, theft, or natural disasters.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded-full bg-red-50 text-red-500 flex items-center justify-center text-xs font-bold mt-0.5">✓</div>
                    <span>Compensation for third-party injuries, damages, and legal liabilities.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded-full bg-red-50 text-red-500 flex items-center justify-center text-xs font-bold mt-0.5">✓</div>
                    <span>Cashless repair facility at network garages.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded-full bg-red-50 text-red-500 flex items-center justify-center text-xs font-bold mt-0.5">✓</div>
                    <span>Peace of mind while driving, knowing that you're protected.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded-full bg-red-50 text-red-500 flex items-center justify-center text-xs font-bold mt-0.5">✓</div>
                    <span>Add-on covers like zero depreciation, roadside assistance, and engine protection for enhanced security.</span>
                  </li>
                </ul>
              ...
              <div className="mt-8 pt-6 border-t border-slate-100 flex flex-col sm:flex-row gap-4">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="font-bold text-slate-800 text-sm group-hover:text-red-500 transition-colors">Liability Insurance</p>
                  </div>
                </div>
                ...
                >
                  <div>
                    ...
                    <p className="font-bold text-white text-sm group-hover:text-red-400 transition-colors">Health Insurance</p>
                  </div>
