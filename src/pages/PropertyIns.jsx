...
import {
  ...
  FaUser, FaCalendarAlt, FaSearch, FaArrowLeft, FaChevronRight
} from 'react-icons/fa';
    ...
    <>
      <div className="relative min-h-screen overflow-hidden bg-[#fafafa] antialiased">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          {/* 🌟 MAIN WRAPPER: items-start રાખવું જરૂરી છે જેથી sticky કામ કરે */}
          <div className="flex flex-col lg:flex-row gap-12 items-start">

            {/* 📌 LEFT SIDE: Sticky Content Box */}
            {/* lg:sticky અને lg:max-h-screen નો ઉપયોગ કરીને આ ભાગને ફિક્સ કર્યો છે */}
            <main className="w-full lg:w-2/3 lg:sticky lg:top-6 lg:max-h-[calc(100vh-48px)] lg:overflow-y-auto no-scrollbar space-y-8 pr-2">
              ...
              <article className="bg-white p-6 sm:p-10 rounded-2xl border border-slate-100 shadow-sm space-y-6">
                ...
                <ul className="space-y-4 text-slate-600">
                  <li className="flex items-start gap-3">
                    ...
                    <span><strong className="text-slate-800">Home Insurance</strong> – Covers houses and personal belongings against risks like fire and theft.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="flex-shrink-0 w-2 h-2 rounded-full bg-red-500 mt-2.5"></span>
                    <span><strong className="text-slate-800">Commercial Property Insurance</strong> – Designed for offices, warehouses, and shops, covering property damages and operational losses.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="flex-shrink-0 w-2 h-2 rounded-full bg-red-500 mt-2.5"></span>
                    <span><strong className="text-slate-800">Landlord Insurance</strong> – Protects property owners against tenant-related damages and loss of rental income.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="flex-shrink-0 w-2 h-2 rounded-full bg-red-500 mt-2.5"></span>
                    <span><strong className="text-slate-800">Package Policies</strong> – Comprehensive plans that include both structural and content coverage under one policy.</span>
                  </li>
                </ul>
                ...
                <ul className="space-y-3.5 text-slate-600">
                  <li className="flex items-start gap-3">
                    ...
                    <span>Financial coverage for rebuilding or repairing damaged property</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded-full bg-red-50 text-red-500 flex items-center justify-center text-xs font-bold mt-0.5">✓</div>
                    <span>Protection against theft, fire, and natural calamities</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded-full bg-red-50 text-red-500 flex items-center justify-center text-xs font-bold mt-0.5">✓</div>
                    <span>Coverage for contents like furniture, appliances, and personal items</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded-full bg-red-50 text-red-500 flex items-center justify-center text-xs font-bold mt-0.5">✓</div>
                    <span>Peace of mind knowing your assets are safeguarded</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded-full bg-red-50 text-red-500 flex items-center justify-center text-xs font-bold mt-0.5">✓</div>
                    <span>Affordable premiums tailored to your property’s value and risks</span>
                  </li>
                </ul>
              ...
              {/* Next Post Floating Banner */}
              <div
                className="py-5 px-6 bg-gradient-to-r from-slate-900 to-slate-800 rounded-2xl flex items-center justify-between group cursor-pointer shadow-md hover:shadow-xl transition-all duration-300"
              ...
              >
                <div>
                  ...
                  <p className="font-bold text-white text-base group-hover:text-red-400 transition-colors">Travel Insurance</p>
                </div>
                <div className="w-10 h-10 bg-white/10 flex items-center justify-center rounded-xl text-white group-hover:bg-red-500 group-hover:scale-105 transition-all duration-300">
                  <FaChevronRight size={14} />
                </div>
              </div>

              {/* Modern Grid Social Share Component */}
              ...
              <section className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-100 shadow-sm">
                ...
                ></textarea>
                <button className="mt-4 px-6 py-3 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white font-bold rounded-xl shadow-md shadow-red-500/10 hover:shadow-lg transition-all active:scale-[0.99] uppercase text-xs tracking-wider">
                  Post Comment
                </button>
              </section>
            </main>
            ...
            <aside className="w-full lg:w-1/3 space-y-8">
              ...
              <div className="bg-white rounded-2xl shadow-sm p-6 border border-slate-100">
                <div className="mb-5">
                  <h3 className="text-xl font-bold text-slate-900 mb-1">Recent Posts</h3>
                  <div className="w-8 h-1 bg-gradient-to-r from-red-500 to-blue-600 rounded-full"></div>
                </div>
